    ...
    if ($_SERVER['REQUEST_METHOD']=="POST") {
        ...
        if($countMasuk < 1){
            ...
            if($countMember > 0){
                ...
                $insertKon = "INSERT INTO konfirmasi (pintu, proses, waktum, waktuk, lama, tarif, saldo, kadaluarsa, nama, status, pesan, kode) VALUES('$pintuK','','$waktu', NOW(), '$intJam Jam $intMenit Menit','$tarif', '0', '', 'tes1','205','tes3','$kode')";
                $sqlInsertKon = mysqli_query($con, $insertKon) or die ("data error");
